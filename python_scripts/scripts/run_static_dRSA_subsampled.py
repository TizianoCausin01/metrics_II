...
from II_analyses.static_dyn import compute_static_dRSA_subsampled
...
# e.g. to call it:
# mpiexec -np 5 python3 run_static_dRSA_subsampled.py --monkey_name=three0 --date=250313 --brain_area=AIT --folder_name=talia_20each_tizi --signal_RDM_metric=cosine --model_RDM_metric=euclidean --model_name=vit_l_16 --img_size=384 --pooling=mean --new_fs=100 --pkg=timm --subsamples_size=200 --n_iterations=20 --random_seed=0

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run subsampled static dRSA for CNN layers"
    )
    ...
    if rank == 0:
        ...
        # Recover the feature-to-neural image mapping used by static dRSA.
        dataset = ImageFolder(
