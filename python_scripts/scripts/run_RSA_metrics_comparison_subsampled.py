...
from II_analyses.metrics_comparison import dyn_RSA_compare_similarity_metrics_subsampled

# e.g. to call it:
# mpiexec -np 5 python3 run_RSA_metrics_comparison_subsampled.py --monkey_name three0 --date 250313 --brain_area AIT --new_fs 100 --subsamples_size 200 --n_iterations 20 --random_seed 0 --metrics cosine_cnt cosine correlation euclidean
